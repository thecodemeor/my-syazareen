...
export class Work implements AfterViewInit, OnDestroy {
    ...
    public portfolioItems: PortfolioItem[] = Array.from({ length: 19 }, (_, i) => ({
        id: i + 1,
        image: `assets/images/works/work-${i + 1}.jpeg`,
        title: `Work ${i + 1}`,
        description: `A selected portfolio piece showcasing visual exploration, layout thinking, and playful design details.`
    }));

    public selectedItem: PortfolioItem | null = null;
    ...
    openPreview(item: PortfolioItem): void {
        this.playHoverSound();
